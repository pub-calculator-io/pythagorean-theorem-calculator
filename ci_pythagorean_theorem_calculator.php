...
Version: 1.0.0
Author: Pythagorean Theorem Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Pythagorean Theorem Calculator by www.calculator.io";

function display_calcio_ci_pythagorean_theorem_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_pythagorean_theorem_calculator', 'display_calcio_ci_pythagorean_theorem_calculator' );